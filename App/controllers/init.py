...
def initialize_db():
    ...
    competition1 = execute_competition_command(admin.id, name='UWI Games 2020', date=date(2020, 2, 29), location='UWI SPEC', platform='HackerRank')# description='The UWI Games is an annual event that brings together students from all campuses to compete in a variety of sports.')
