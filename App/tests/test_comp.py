...
# from wsgi import competition_cli
...
# class TestCompetitionCommands(unittest.TestCase):
#     def setUp(self):
#         self.runner = click.testing.CliRunner()

#     def test_create_competition_command(self):
#         result = self.runner.invoke(competition_cli, ["create"])
#         self.assertIn("Competition Created Successfully", result.output)

#     def test_get_competition_by_id_command(self):
#         result = self.runner.invoke(competition_cli, ["get_competition", "1"])
#         self.assertIn("No competition found", result.output)

#     def test_list_competitions_command(self):
#         result = self.runner.invoke(competition_cli, ["list"])
